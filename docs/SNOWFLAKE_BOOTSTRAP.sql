...
GRANT CREATE SEMANTIC VIEW ON SCHEMA ABBVIE_DATAOPS_DEV.CURATED TO ROLE ABBVIE_DATAOPS_DEPLOY;
...
GRANT SELECT, REFERENCES, MONITOR
    ON FUTURE SEMANTIC VIEWS IN SCHEMA ABBVIE_DATAOPS_DEV.CURATED
    TO ROLE ABBVIE_DATAOPS_DEPLOY;
